...
const PostsPage = ({ posts, error }) => {
	...
	return <Container> 
	<div style={{margin: "0 auto", width: 400}}>All posts made on Vinder sorted by most recent</div>
	{posts.map((e) => <Post key={e.id} name={e.AuthorName} date={e.date} text={e.Content} tags={e.tags} /> )}
	</Container>
}
